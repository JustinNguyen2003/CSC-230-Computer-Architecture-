...
wait:
	...
	rjmp set_direction ;jmp if button is being pressed
...
wait4:
	...
	;cp DATAL, BUTTON_UP_ADCL
	;cpc DATAH, BUTTON_UP_ADCH
	;brlo check_above_right ;go to check if up button is being pressed
	;rjmp check_below_down  ; go to check if down button is being pressed
...
;check_above_right:
	;cp DATAL, BUTTON_RIGHT_ADCL
	;cpc DATAH, BUTTON_RIGHT_ADCH
	;brsh set_increase ;up button is being pressed
	;reti

;check_below_down:
	;cp DATAL, BUTTON_DOWN_ADCL
	;cpc DATAH, BUTTON_DOWN_ADCH
	;brlo set_decrease ; down button is being pressed
	;reti
...
set_increase:
	push r16
	lpm r16, Z
	cpi r16, 95  ;check if index is above the limit
	breq return 
	pop r16
	adiw Z, 1 ;increase Z
	lds r27, CURRENT_CHARSET_INDEX
	inc r27 ;increase index
...
set_decrease:
	lds r27, CURRENT_CHARSET_INDEX 
	cpi r27, 0
	breq return ; check if index is below the limit
	sbiw Z, 1 ;decrease Z
	dec r27 ; decrease index
	sts CURRENT_CHARSET_INDEX, r27
	reti
